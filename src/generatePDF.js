...
// STRETCH 1: Make it pretty
function buildHTML(reportData) {
    const { total_orders, total_revenue, top_products, orders_per_day, days } = reportData;
...
<body>
    ...
    <div class="subtitle">
        ...
        <span class="badge-days">Last ${days} days</span>
    </div>
    ...
    <div class="summary-grid">
        ...
        <div class="summary-card">
            ...
            <div class="value">$${total_orders > 0 ? (total_revenue / total_orders).toFixed(2) : '0.00'}</div>
        </div>
    </div>
    ...
    <div class="footer">
        Generated by FlyRank PDF Report Generator • 
        Page <span class="page-number">1</span> of <span class="page-number">1</span>
    </div>
</body>
</html>
    `;
